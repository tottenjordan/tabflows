...
- [Evaluation & Experiment Tracking](file:///usr/local/google/home/jordantotten/antigravity/tabflows/docs/notes/evaluation_and_experiments.md): Model evaluation metrics (Log Loss, AUC-ROC, confusion matrix), feature importance attributions, full-lifecycle experiment tracking across pipelines, DoE campaigns, deployments, batch predictions, and `log-experiment` CLI usage.
