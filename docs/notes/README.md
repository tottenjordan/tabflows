...
- [Inference & Serving](inference.md): Online real-time endpoint deployment, Champion vs Challenger traffic splitting, JSON instance prediction, batch inference execution, and endpoint resource cleanup.
